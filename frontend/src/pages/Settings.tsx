/**
 * @file Settings.tsx
 * @description Settings page component for customizing theme (Light/Dark), currency display symbol, and date formatting options.
 */
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="mt-3 flex gap-2 p-3 text-sm text-amber-800 bg-amber-50 border border-amber-200 dark:bg-amber-900/20 dark:border-amber-800/50 dark:text-amber-300 rounded-lg">
                  ...
                  <p>
                    <strong>Important Note:</strong> Changing the currency symbol only changes how values are visually
                    displayed. It does not perform any automatic currency conversion on your historical transaction data.
                  </p>
                </div>
              </div>
